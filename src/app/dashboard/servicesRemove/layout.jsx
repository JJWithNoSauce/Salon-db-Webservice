...
const Layout = ({children}) => {
    return (
        <div className="form-control">
            ...
            <div>โดยเมื่อกดปุ่มแล้วทางระบบจะนำข้อมูลออกโดยอัตโนมัติแบบไม่แจ้งเตือน โปรดกดปุ่มกลับไปยังหน้าจัดการแล้วรีเฟรชหน้าจัดการ (f5) เพื่อเช็คว่าข้อมูลถูกนำออกหรือไม่ หากยังไม่ถูกนำออกทางระบบอาจกำลังอยู่ในขั้นตอนกระบวนการ หากไม่ถูกนำออกเลยโปรดเช็คว่าข้อมูลที่กรอกไปนั้นถูกต้องและตรงกับข้อมูลบริการที่ต้องการจะนำออก</div>
